package com.jia.jelly.smart.Permission;
...
import com.jia.jelly.jellycore.utils.base_utils.PermissionUtils;
import com.jia.jelly.jellycore.utils.glide_util.ImageDecoder;
import com.jia.jelly.jellycore.utils.glide_util.ImageSize;
import com.jia.jelly.jellycore.utils.glide_util.ImageUtils;
...
public class PermissionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initImage() {
        ...
        Bitmap bitmap = null;
        try {
            bitmap = decoder.decode(file, imageSize);
        } catch (IOException e) {
            e.printStackTrace();
        }
